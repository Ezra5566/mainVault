...
- **Freemium pilot** → upsell to enterprise.  
- **Government tenders** for digital transformation.

## next actions
- Conduct **market interviews** in Nairobi & Mombasa (5 each).  
- Build a **proof‑of‑concept** for one segment (e.g., crop‑health).  
- Draft a **go‑to‑market plan** with pricing hypothesis.
